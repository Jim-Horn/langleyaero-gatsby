  ...
  <Layout>
    ...
    <div class="entry-content">
      <p>
        ...
        control, work order generation, including task management, secondary
        tasks triggered when specific circumstances call for it, automated log
        entry and work order file system.
      </p>
      ...
      <p>
        ...
        maintenance of your aircraft, that shelf life limited parts and
        materials are not used past their intended storage life, that all
        precision tools are maintained to current standards and readings and
        settings are accurate, and that the work done on your aircraft will be
        properly documented to meet Transport Canada requirements.
      </p>
